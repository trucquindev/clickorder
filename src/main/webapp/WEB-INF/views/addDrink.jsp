...
<head>
    ...
    <style>
        ...
        /* Cải thiện giao diện cho các phần tử */
        .form-group {
            width: 100%;
        }
...
<form action="/admin/drinks/savedDrink" method="post">
    <div class="form-group">
        ...
        <input type="text" name="name" id="name" required placeholder="Nhập tên đồ uống"/>
    </div>
    <div class="form-group">
        <label for="description">Mô tả:</label>
        <input type="text" name="description" id="description" required placeholder="Nhập mô tả đồ uống"/>
    </div>
    <div class="form-group">
        <label for="price">Giá (VND):</label>
        <input type="text" name="price" id="price" required placeholder="Nhập giá đồ uống"/>
    </div>
